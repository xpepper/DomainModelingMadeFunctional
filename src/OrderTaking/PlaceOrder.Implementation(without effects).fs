...
module OrderQuantity =
    let create fieldName productCode =
        OrderQuantity.create fieldName productCode >> failOnError
...
let toCustomerInfo (unvalidatedCustomerInfo: UnvalidatedCustomerInfo) =
    let firstName = unvalidatedCustomerInfo.FirstName |> String50.create "FirstName"
    let lastName = unvalidatedCustomerInfo.LastName |> String50.create "LastName"

    let emailAddress =
        unvalidatedCustomerInfo.EmailAddress |> EmailAddress.create "EmailAddress"
...
let toAddress (checkAddressExists: CheckAddressExists) unvalidatedAddress =
    ...
    let addressLine2 =
        checkedAddress.AddressLine2 |> String50.createOption "AddressLine2"

    let addressLine3 =
        checkedAddress.AddressLine3 |> String50.createOption "AddressLine3"

    let addressLine4 =
        checkedAddress.AddressLine4 |> String50.createOption "AddressLine4"
...
let toProductCode (checkProductCodeExists: CheckProductCodeExists) productCode =
    ...
    productCode |> ProductCode.create "ProductCode" |> checkProduct


/// Helper function for validateOrder
let toValidatedOrderLine checkProductExists (unvalidatedOrderLine: UnvalidatedOrderLine) =
    let orderLineId =
        unvalidatedOrderLine.OrderLineId |> OrderLineId.create "OrderLineId"
...
let validateOrder: ValidateOrder =
    fun checkProductCodeExists checkAddressExists unvalidatedOrder ->
        let orderId = unvalidatedOrder.OrderId |> OrderId.create "OrderId"
